...
const page = () => {
  return (
    ...
    <div>
      <Head>
        <title>AI-Based Interview</title>
      ...
      <main className="min-h-screen">
        ...
        <header className="w-full py-8 bg-gray-100 shadow-md">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            <h1 className="text-3xl font-bold text-primary">AI-Based Interview</h1>
        ...
        <section id="features" className="py-16 bg-white px-6 md:px-0">
          <div className="container mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-gray-800">
              Our AI Mock Interview platform offers a range of features:
            </p>
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Sarvesh Dhok</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Animesh Murai</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Aishwary Gathe</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Nidhi Manyam</h4>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="py-8 bg-black text-white text-center">
        <p>© 2024 RBU Nagpur. All rights reserved.</p>
      </footer>
    </div>
  )
}
